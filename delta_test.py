...
CURRENT_SOURCE.write("SOUR:PDEL:SWE ON")

CURRENT_SOURCE.write("SOUR:SWE:SPAC LIN")

CURRENT_SOURCE.write(("SOUR:CURR:STAR 1e-3"))
CURRENT_SOURCE.write(("SOUR:CURR:STOP 14e-4"))
