...
def update_combobox(event):
    ...
    input_text = temperature_entry.get("1.0", "end-1c")
...
if __name__=="__main__":
 ...
 # Title
    ...
    # Temperature Tab
    temperature_lframe = LabelFrame(TEMPERATURE_TAB, text="Temperature and Time Controls", fg="white", bg=tab_bg)
    temperature_lframe.grid(row=0, column=0, rowspan=3,sticky="nsew", padx=350, pady=150)

    select_temp_lframe = LabelFrame(temperature_lframe, text="Temperature(s)(in K)", fg="white", bg=tab_bg)
    select_temp_lframe.grid(row=0, column=0, padx=10, pady=(5, 10), sticky="w")

    temperature_entry = Text(select_temp_lframe, font=(10), width=20, height=1)
    temperature_entry.grid(row=0, column=0, pady=10, padx=10, ipady=5)
    
    temperature_entry.bind("<KeyRelease>", update_combobox) 
   

    time_lframe = LabelFrame(temperature_lframe, text="Total Time( in s)", fg="white", bg=tab_bg)
    ...
    time_interval_lframe = LabelFrame(temperature_lframe, text="Time Interval(in s)", fg="white", bg=tab_bg)
